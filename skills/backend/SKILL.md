...
- For a standard CRUD controller, inspect a nearby controller and the canonical template in `docs/agent/STANDARD_CRUD_SERVICE_REPOSITORY.md`; keep HTTP handling thin and put business writes in the service.
