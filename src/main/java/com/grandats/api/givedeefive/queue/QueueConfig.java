...
public class QueueConfig {
    public static final String EXCHANGE_NAME = "com.grandats.api.givedeefive";
    public static final String QUEUE_GENERIC_NAME = "com.grandats.api.givedeefive.generic";
    public static final String QUEUE_CALCULATE_SCORE = "com.grandats.api.givedeefive.calculate.score";
    public static final String QUEUE_SEND_NOTIFY = "com.grandats.api.givedeefive.send.notify";
    public static final String QUEUE_SHEDULE_CALCULATE_DE = "com.grandats.api.givedeefive.schedule.calculate.de";
    public static final String QUEUE_SHEDULE_CALCULATE_USER_LEVEL = "com.grandats.api.givedeefive.schedule.calculate.user.level";
    public static final String QUEUE_REWARD_TRADE_PROCESS = "com.grandats.api.givedeefive.reward.trade.process";
    public static final String ROUTING_KEY = "com.grandats.api.givedeefive.routing.key";
