...
public class ConstantData {
    ...
    public static final String DEFAULT_PROJECT_ROOT_PATH = "src/main/java/com/grandats/api/givedeefive";
    public static final String DEFAULT_PROJECT_ROOT_PACKAGE = "com.grandats.api.givedeefive";
